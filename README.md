...
sudo pacman -S grim satty wl-clipboard
...
# Ctrl+Alt+Shift+L: 截取选定区域到剪贴板
bind = CTRL_ALT_SHIFT, L, exec, grim -g "$(slurp)" - | wl-copy

# Ctrl+Alt+Shift+K: 截取选定区域并保存到文件夹
bind = CTRL_ALT_SHIFT, K, exec, grim -g "$(slurp)" ~/Pictures/Screenshots/$(date +'%Y-%m-%d_%H-%M-%S.png')
